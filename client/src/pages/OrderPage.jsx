          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm ring-1 ring-gray-900/5 overflow-hidden">
              <div className="px-6 py-4 border-b border-gray-100">
                ...
                <p className="text-sm text-gray-500 mt-0.5">{order.orderItems.length} item{order.orderItems.length !== 1 ? 's' : ''}</p>
              </div>
              ...
              {currentUser?.isAdmin &&
                ...
                !order.isDelivered && (
                  <button
                    ...
                    className="mt-4 w-full px-4 py-2.5 bg-gray-900 text-white text-sm font-medium rounded-xl hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 transition-colors"
                  >
                    Mark as Delivered
                  </button>
                )}
