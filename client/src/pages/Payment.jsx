      ...
      <main className="flex-1 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-xs font-medium text-neutral-900">Cart</span>
              </div>

              <div className="flex-1 h-0.5 bg-neutral-900 mx-2" />
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-xs font-medium text-neutral-900">Shipping</span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-xs font-medium text-neutral-900">Payment</span>
              </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="mt-2 text-xs font-medium text-neutral-400">Place Order</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-6 sm:p-8">
            <h2 className="text-2xl font-semibold text-neutral-900 mb-2">Select Payment Method</h2>
            <p className="text-neutral-500 mb-6">Choose how you would like to pay for your order</p>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-3">
                ...
                >
                  ...
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mr-4 transition-colors ${
                    paymentMethod === "Cash on Delivery" ? "border-neutral-900" : "border-neutral-300"
                  }`}>
                    {paymentMethod === "Cash on Delivery" && (
                ...
                >
                  ...
                  />
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mr-4 transition-colors ${
                    paymentMethod === "UPI" ? "border-neutral-900" : "border-neutral-300"
                  }`}>
                    {paymentMethod === "UPI" && (
                      <div className="w-2.5 h-2.5 rounded-full bg-neutral-900" />
                    )}
                ...
                >
                  ...
                  />
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center mr-4 transition-colors ${
                    paymentMethod === "Card" ? "border-neutral-900" : "border-neutral-300"
                  }`}>
                    {paymentMethod === "Card" && (
                      <div className="w-2.5 h-2.5 rounded-full bg-neutral-900" />
                    )}
              ...
              <button
                type="submit"
                className="w-full mt-8 bg-neutral-900 text-white py-4 px-6 rounded-xl font-medium text-base hover:bg-neutral-800 active:scale-[0.98] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:ring-offset-2"
              >
